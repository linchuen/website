...
const MythSlide: React.FC = () => {
  ...
  const items = [
    {
      title: "焦油坑",
      text: "軟體開發充滿隱藏複雜性，隨著專案規模增大，開發像是在泥濘中前進，每個小錯誤或不明確需求都可能讓專案陷得更深。",
    },
    {
      title: "人月神話",
      text: "人 × 月 ≠ 專案完成時間，增加人力不會線性縮短開發時間，反而可能因溝通成本與培訓需求增加而延遲專案。",
    },
    {
      title: "沒有銀彈",
      text: "沒有單一方法可以徹底解決軟體開發中的所有問題。就像醫生沒有一顆藥能治好所有病，專案中的每個問題都需要不同策略來解決。",
    },
    {
      title: "外科手術團隊",
